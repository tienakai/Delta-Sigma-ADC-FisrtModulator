...
VL_ATTR_COLD void Vlng___024root___eval_initial(Vlng___024root* vlSelf) {
    ...
    vlSelf->__Vtrigprevexpr___TOP__CIC_verilog_v1__DOT__clk_div__0 
        = vlSelf->CIC_verilog_v1__DOT__clk_div;
}
...
#endif
            VL_FATAL_MT("CIC_verilog_v1.v", 2, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vlng___024root___dump_triggers__act(Vlng___024root* vlSelf) {
    ...
    if ((2ULL & vlSelf->__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 1 is active: @(posedge CIC_verilog_v1.clk_div or posedge rst)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vlng___024root___dump_triggers__nba(Vlng___024root* vlSelf) {
    ...
    if ((2ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 1 is active: @(posedge CIC_verilog_v1.clk_div or posedge rst)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vlng___024root___ctor_var_reset(Vlng___024root* vlSelf) {
    ...
    vlSelf->CIC_verilog_v1__DOT__I1 = VL_RAND_RESET_I(14);
    vlSelf->CIC_verilog_v1__DOT__I2 = VL_RAND_RESET_I(14);
    vlSelf->CIC_verilog_v1__DOT__I3 = VL_RAND_RESET_I(14);
    vlSelf->CIC_verilog_v1__DOT__D1 = VL_RAND_RESET_I(14);
    vlSelf->CIC_verilog_v1__DOT__D2 = VL_RAND_RESET_I(14);
    vlSelf->CIC_verilog_v1__DOT__Y = VL_RAND_RESET_I(14);
    vlSelf->CIC_verilog_v1__DOT__clk_div = VL_RAND_RESET_I(1);
    vlSelf->CIC_verilog_v1__DOT__Decimator_clk__DOT__counter = VL_RAND_RESET_I(6);
    vlSelf->CIC_verilog_v1__DOT__Decimator_clk__DOT__ovf_flag = VL_RAND_RESET_I(1);
    vlSelf->CIC_verilog_v1__DOT__differentiator_0__DOT__Q = VL_RAND_RESET_I(14);
    vlSelf->CIC_verilog_v1__DOT__differentiator_1__DOT__Q = VL_RAND_RESET_I(14);
    vlSelf->CIC_verilog_v1__DOT__differentiator_2__DOT__Q = VL_RAND_RESET_I(14);
    vlSelf->__Vdly__CIC_verilog_v1__DOT__I3 = VL_RAND_RESET_I(14);
    vlSelf->__Vtrigprevexpr___TOP__clk__0 = VL_RAND_RESET_I(1);
    vlSelf->__Vtrigprevexpr___TOP__rst__0 = VL_RAND_RESET_I(1);
    vlSelf->__Vtrigprevexpr___TOP__CIC_verilog_v1__DOT__clk_div__0 = VL_RAND_RESET_I(1);
}
