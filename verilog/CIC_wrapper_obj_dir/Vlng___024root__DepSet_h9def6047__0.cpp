...
void Vlng___024root___eval_triggers__act(Vlng___024root* vlSelf) {
    ...
    vlSelf->__VactTriggered.set(1U, (((IData)(vlSelf->CIC_wrapper__DOT__uut__DOT__clk_div) 
                                      & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__CIC_wrapper__DOT__uut__DOT__clk_div__0))) 
                                     | ((IData)(vlSelf->rst) 
                                        & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__rst__0)))));
